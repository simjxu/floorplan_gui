...
class MainCanvas(tk.Canvas):
	def __init__(self, *args, **kwargs):
		...
		my_circle1 = Circle(self,column=0, row=0)
		my_circle2 = Circle(self,column=5, row=0)
...
# 		self.configure(bg='white', height=500, width=500)

# 		self.my_circle = self.create_oval(50, 50, 100, 100, fill="blue", outline="white", width=2)
# 		self.make_draggable(self)
